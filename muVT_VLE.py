...
if units_type == 'Reduced':
    # Print to Screen
    print '{:^20}'.format('T*') +'  {:^20}'.format('lnZ') +'  {:^20}'.format('p(1)*') \
        +'  {:^20}'.format('p(2)*') +'  {:^20}'.format('rho(1)*') \
        +'  {:^20}'.format('rho(2)*') +'  {:^20}'.format('u(1)*') +'  {:^20}'.format('u(2)*')
    print '{:20.10e}'.format(temperature) +'{:20.10e}'.format(mu_test/temperature) \
        +'  {:20.10e}'.format(pressure[0]) \
    ...
    # Write to File
    saturation_output.write( '{:^20}'.format('T*') +'  {:^20}'.format('lnZ') +'  {:^20}'.format('p(1)*') 
                             +'  {:^20}'.format('p(2)*') +'  {:^20}'.format('rho(1)*') 
                             +'  {:^20}'.format('rho(2)*') +'  {:^20}'.format('u(1)*') 
                             +'  {:^20}'.format('u(2)*') + '\n' )
    saturation_output.write('{:20.10e}'.format(temperature) +'{:20.10e}'.format(mu_test/temperature) 
                            +'  {:20.10e}'.format(pressure[0])
                            +'  {:20.10e}'.format(pressure[1]) +'  {:20.10e}'.format(nmols[0]/volume) 
                            +'  {:20.10e}'.format(nmols[1]/volume) +'  {:20.10e}'.format(U[0]/nmols[0]) 
                            +'  {:20.10e}'.format(U[1]/nmols[1]) +'\n')
    ...
    # Print to Screen
    print '{:^20}'.format('T (K)') +'  {:^20}'.format('lnZ') +'  {:^20}'.format('p(1) (bar)') +'  {:^20}'.format('p(2) (bar)') \
        +'  {:^20}'.format('rho(1) (mol/m3)') +'  {:^20}'.format('rho(2) (mol/m3)') \
        +'  {:^20}'.format('u(1) (kJ/mol)') +'  {:^20}'.format('u(2) (kJ/mol)')
    print '{:20.10e}'.format(temperature) +'{:20.10e}'.format(mu_test*LJ_epsilon_kB/temperature) \
    ...
    #Write to File
    saturation_output.write('{:^20}'.format('T (K)') +'  {:^20}'.format('lnZ') 
                            +'  {:^20}'.format('p(1) (bar)')
                            +'  {:^20}'.format('p(2) (bar)') +'  {:^20}'.format('rho(1) (mol/m3)') 
                            +'  {:^20}'.format('rho(2) (mol/m3)') +'  {:^20}'.format('u(1) (kJ/mol)') 
                            +'  {:^20}'.format('u(2) (kJ/mol)') + '\n' )
    saturation_output.write('{:20.10e}'.format(temperature) 
                            +'{:20.10e}'.format(mu_test*LJ_epsilon_kB/temperature) 
                            +'  {:20.10e}'.format(pressure[0]*pressure_scale) 
